...
<form class="mt-5 space-y-4" action="?/login" method="POST">
	<div>
	...
	<button class="btn btn-primary w-full my-5" type="submit">Login</button>
</form>

{#if form?.error}
	<div role="alert" class="alert alert-error mt-10 text-sm w-2/3 mx-auto">
